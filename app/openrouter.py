...
GOSUSLUGI_EDIT_PROMPT = (
    ...
    "clothes on #FFFFFF. If the child is a girl: replace clothing with a pink "
    "child's tank top (розовая майка). If you cannot tell the child's sex/"
    "gender: still use that same pink tank top — default to pink, do not guess "
    "a dark shirt. If the child is a boy: replace with a dark solid child's "
    "t-shirt (navy, charcoal, or dark blue). Adults in a light tank/tee "
    "(and not in religious clothing): still the business suit. "
...
GOSUSLUGI_SCORING_PROMPT = (
    ...
    "children: never a suit; girl or unknown sex → pink tank (розовая майка); "
    "boy → dark navy/charcoal t-shirt — no pale/white tank or tee on white bg; "
