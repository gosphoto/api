...
GOSUSLUGI_EDIT_PROMPT = (
    ...
    "open (hair must not cover eyes, brows, or face oval). "
    "If stray hairs or flyaways stick out from the silhouette (crown, temples, sides), "
    "lightly gather and tuck them so the outline is neat — do not cut hair, do not "
    "change the hairstyle, length, color, or volume, do not invent a bun or updo, "
    "keep ears and existing earrings visible. "
    "Gaze straight into the "
...
GOSUSLUGI_SCORING_PROMPT = (
    ...
    "open face, lightly tuck flyaway hair if it sticks out (same hairstyle); "
