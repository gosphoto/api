...
GOSUSLUGI_EDIT_PROMPT = (
    ...
    "BANGS / FRINGE (чёлка): if bangs cover or touch the eyebrows or forehead, "
    "slightly comb them aside — part to one side or both sides — just enough so "
    "brows and the upper forehead are clearly visible. Do NOT remove bangs "
    "entirely, do NOT invent a new fringe style, do NOT shorten the main hair: "
    "only a light side-sweep of the fringe that was blocking brows/forehead. "
...
GOSUSLUGI_SCORING_PROMPT = (
    ...
    "open face with no hair on the oval (tuck/sweep away if needed); if bangs "
    "(чёлка) cover brows — lightly comb fringe aside to one/both sides so brows "
    "and forehead show; MUST erase "
