...
GOSUSLUGI_EDIT_PROMPT = (
    ...
    "Pupils: if a lamp / ring-light / flash catchlight is visible inside the "
    "pupils (white ring, bright disk, or hotspot in the iris/pupil), REMOVE that "
    "reflection so the pupils look natural and dark — do not change eye color, "
    "iris texture, or gaze; do not invent new catchlights. "
...
GOSUSLUGI_SCORING_PROMPT = (
    ...
    "open face with no hair on the oval (tuck/sweep away if needed), MUST erase "
    ...
    "visible under frames; no lamp/ring-light catchlight inside pupils; "
    "no hats/uniforms (keep religious cover + clothing "
    "if face oval open); "
