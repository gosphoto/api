...
# Live /api/process edit (OpenRouter /images). Nano Banana / Gemini 2.5 Flash Image.
...
FEEDBACK_MAX_FULL_NAME_CHARS = int(os.getenv("FEEDBACK_MAX_FULL_NAME_CHARS", "200"))
FEEDBACK_MIN_FULL_NAME_CHARS = int(os.getenv("FEEDBACK_MIN_FULL_NAME_CHARS", "5"))
FEEDBACK_MAX_GOSUSLUGI_ERROR_CHARS = int(
    os.getenv("FEEDBACK_MAX_GOSUSLUGI_ERROR_CHARS", "1000")
)
FEEDBACK_MIN_GOSUSLUGI_ERROR_CHARS = int(
    os.getenv("FEEDBACK_MIN_GOSUSLUGI_ERROR_CHARS", "3")
)
...
PRICE_KOPECKS = int(os.getenv("PRICE_KOPECKS", "39000"))
